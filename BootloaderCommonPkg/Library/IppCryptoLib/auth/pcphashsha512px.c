...
#ifdef _SLIMBOOT_OPT
void SBLUpdateSHA512(void* pHash, const Ipp8u* pMsg, int msgLen, const void* pParam)
{
#if (FixedPcdGet32 (PcdCryptoShaOptMask) & IPP_CRYPTO_SHA384_G9)
   UpdateSHA512G9 (pHash, pMsg, msgLen, pParam);
#elif (FixedPcdGet32 (PcdCryptoShaOptMask) & IPP_CRYPTO_SHA384_W7)
   UpdateSHA512W7 (pHash, pMsg, msgLen, pParam);
#else
   UpdateSHA512 (pHash, pMsg, msgLen, pParam);
#endif
}
#endif
